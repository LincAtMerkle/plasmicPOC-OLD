...
const primary = defineStyle({
  border: '10px solid', // change the appearance of the border
  borderRadius: 20, // remove the border radius
...
//1. figma tokene to css variables
//2. register variables with charka theme
//3. register component levels themes 
