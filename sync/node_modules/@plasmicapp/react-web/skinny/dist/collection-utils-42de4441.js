...
import { a as isString } from './common-98719219.js';
import { t as toChildArray, g as getElementTypeName } from './react-utils-b5dc6320.js';
import { g as getPlumeType, P as PLUME_STRICT_MODE } from './plume-utils-1e225de5.js';
...
function deriveItemsFromChildren(children, opts) {
    ...
    return { items: flattenedChildren(children), disabledKeys };
}
function useDerivedItemsFromChildren(children, opts) {
    const { itemPlumeType, sectionPlumeType, invalidChildError, requireItemValue, } = opts;
...
function renderAsCollectionChild(child, opts) {
    ...
    if (plumeType === opts.itemPlumeType) {
        ...
        , { 
            ...
            items: getChildProp(group, "children") }, (c) => renderAsCollectionChild(c, opts)));
    }
}
...
//# sourceMappingURL=collection-utils-42de4441.js.map
