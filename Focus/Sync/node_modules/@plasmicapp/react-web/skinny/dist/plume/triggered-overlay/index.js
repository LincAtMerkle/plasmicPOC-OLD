import { c as __read, a as __assign, p as pick, b as __spreadArray } from '../../common-182a0b0c.js';
import * as React from 'react';
import { useOverlay, useOverlayPosition, DismissButton } from '@react-aria/overlays';
import { FocusScope } from '@react-aria/focus';
import * as ReactDOM from 'react-dom';
import { d as mergeRefs, u as useIsomorphicLayoutEffect, m as mergeProps } from '../../react-utils-35cb2a4e.js';
...
function useTriggeredOverlay(plasmicClass, props, config, outerRef, isDismissable) {
    ...
    var variants = __assign(__assign({}, pick.apply(void 0, __spreadArray([props], __read(plasmicClass.internalVariantProps)))), mergeVariantToggles({ def: config.isPlacedTopVariant, active: placementAxis === "top" }, { def: config.isPlacedBottomVariant, active: placementAxis === "bottom" }, { def: config.isPlacedLeftVariant, active: placementAxis === "left" }, { def: config.isPlacedRightVariant, active: placementAxis === "right" }));
    var args = __assign(__assign({}, pick.apply(void 0, __spreadArray([props], __read(plasmicClass.internalArgProps)))), (_a = {}, _a[config.contentSlot] = (React.createElement(FocusScope, { restoreFocus: true },
