...
import sty from "./PlasmicNarrative.module.css"; // plasmic-import: 0_xbkoU01HZ/css
...
export type PlasmicNarrative__VariantMembers = {
  props: "props";
  theming: "theming";
};
export type PlasmicNarrative__VariantsArgs = {
  props?: SingleBooleanChoiceArg<"props">;
  theming?: SingleBooleanChoiceArg<"theming">;
};
type VariantPropType = keyof PlasmicNarrative__VariantsArgs;
export const PlasmicNarrative__VariantProps = new Array<VariantPropType>(
  "props",
  "theming"
);

export type PlasmicNarrative__ArgsType = {};
type ArgPropType = keyof PlasmicNarrative__ArgsType;
export const PlasmicNarrative__ArgProps = new Array<ArgPropType>();

export type PlasmicNarrative__OverridesType = {
  root?: p.Flex<"div">;
...
export interface DefaultNarrativeProps {}

function PlasmicNarrative__RenderFunc(props: {
  variants: PlasmicNarrative__VariantsArgs;
  args: PlasmicNarrative__ArgsType;
  overrides: PlasmicNarrative__OverridesType;
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__wvRf)}
          >
            <Nav
            ...
            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(projectcss.all, sty.freeBox___4ZlDy, {
                [sty.freeBoxprops___4ZlDYsg2Xi]: hasVariant(
                  $state,
                  "props",
                  "props"
                )
            ...
            >
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__dx67I)}
              >
                <SubNav
                ...
                {false ? (
                  <div
                    className={classNames(projectcss.all, sty.freeBox__caV9K)}
                  >
                    <button
                      className={classNames(
                        projectcss.all,
              ...
              {true ? (
                <p.Stack
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.freeBox__zvdep)}
                >
                  <Heading
                  ...
                  <Text
                    ...
                    className={classNames("__wab_instance", sty.text___1WpMf, {
                      [sty.textprops___1WpMFsg2Xi]: hasVariant(
                        $state,
                        "props",
                        "props"
                      )
                  ...
                  >
                    <div
                      className={classNames(
                        ...
                        sty.text__iCtTr,
                        {
                          [sty.textprops__iCtTrsg2Xi]: hasVariant(
                            $state,
                            "props",
                            "props"
                          ),
                          [sty.texttheming__iCtTr1VdyS]: hasVariant(
                            $state,
                            "theming",
                            "theming"
                          )
                    ...
                    >
                      {
                        "A clients various Themes, Content & Templates for each Brand"
                      }
                    </div>
                  </Text>
                    ...
                    >
                      <Tab
                        className={classNames(
                          ...
                          sty.tab___30ZXy,
                          {
                            [sty.tabtheming___30ZXy1VdyS]: hasVariant(
                              $state,
                              "theming",
                              "theming"
                            )
                      ...
                      <Tab
                        className={classNames("__wab_instance", sty.tab__dtbaG)}
                      >
                        <div
                          className={classNames(
                            projectcss.all,
                      ...
                      <Tab
                        className={classNames(
                          ...
                          sty.tab__pfFsH,
                          {
                            [sty.tabprops__pfFsHsg2Xi]: hasVariant(
                              $state,
                              "props",
                              "props"
                            )
                    ...
                    >
                      ...
                      <TabPanel
                        className={classNames(
                          ...
                          sty.tabPanel__jnthb,
                          {
                            [sty.tabPanelprops__jnthBsg2Xi]: hasVariant(
                              $state,
                              "props",
                              "props"
                            )
                      ...
                      >
                        <div
                          className={classNames(
                            ...
                            sty.text__sv8Gr,
                            {
                              [sty.textprops__sv8GRsg2Xi]: hasVariant(
                                $state,
                                "props",
                                "props"
                              )
                      ...
                      >
                        ...
                        <div
                          className={classNames(
                            ...
                            sty.text__yD3SX,
                            {
                              [sty.texttheming__yD3SX1VdyS]: hasVariant(
                                $state,
                                "theming",
                                "theming"
                              )
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicNarrative__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicNarrative__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    // Specify args directly as props
    Omit<PlasmicNarrative__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicNarrative__ArgProps,
          internalVariantPropNames: PlasmicNarrative__VariantProps
        }),
      [props, nodeName]
    );

    return PlasmicNarrative__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicNarrative";
  } else {
    func.displayName = `PlasmicNarrative.${nodeName}`;
  }
  return func;
}

export const PlasmicNarrative = Object.assign(
  // Top-level PlasmicNarrative renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicNarrative
    internalVariantProps: PlasmicNarrative__VariantProps,
    internalArgProps: PlasmicNarrative__ArgProps,
...
export default PlasmicNarrative;
/* prettier-ignore-end */
